...
from spinup.algos.sac_pytorch.sac_adapt_early_stopping import sac_adapt
import time
...
if __name__ == '__main__':
    ...
    setting_names = ['env_name', 'seed', 'c', 'hidden_sizes']
