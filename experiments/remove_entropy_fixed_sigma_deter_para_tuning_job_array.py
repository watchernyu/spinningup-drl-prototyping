...
from spinup.algos.sac_pytorch.sac_adapt_remove_entropy_fixed_sigma_deter import sac_adapt
import time
...
if __name__ == '__main__':
    ...
    setting_names = ['env_name', 'seed', 'lr', 'batch_size', 'start_steps']
...
####################################################################################################
    ...
    eg = ExperimentGrid(name='sac_adapt_remove_entropy_fixed_sigma_deter')
    eg.add('epochs', 200)
    ...
    eg.add('batch_size', actual_setting['batch_size'], 'batch', True)
    #eg.add('hidden_sizes', actual_setting['hidden_sizes'], 'hid', True)
    eg.add('start_steps', actual_setting['start_steps'], 'start', True)
    
    
    #if actual_setting['env_name'] == 'Humanoid-v2':
    #    eg.add('alpha',0.05)

    eg.run(sac_adapt, num_cpu=args.cpu)
