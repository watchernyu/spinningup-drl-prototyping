...
from spinup.algos.sac_pytorch.sac_adapt_fixed_sigma_tanh_entropy_deter12 import sac_adapt
import time
...
####################################################################################################
    ...
    eg = ExperimentGrid(name='sac_adapt_fixed_sigma_tanh_entropy_deter12')
    eg.add('epochs', 200)
