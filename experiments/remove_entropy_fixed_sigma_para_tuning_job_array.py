...
from spinup.algos.sac_pytorch.sac_adapt_remove_entropy_fixed_sigma import sac_adapt
import time
...
if __name__ == '__main__':
    ...
    setting_names = ['env_name', 'seed', 'lr', 'batch_size']
...
####################################################################################################
    ...
    eg = ExperimentGrid(name='sac_adapt_remove_entropy_fixed_sigma')
    eg.add('epochs', 200)
