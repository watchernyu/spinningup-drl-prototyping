...
def sac_overwrite(env_fn, hidden_sizes=[256, 256], seed=0,
                  ...
                  eta_final=1.0, no_eta_anneal=False):
    ...
    value_net = Mlp(obs_dim,1,hidden_sizes, hidden_activation=hidden_activation)
    target_value_net = Mlp(obs_dim,1,hidden_sizes, hidden_activation=hidden_activation)
    q1_net = Mlp(obs_dim+act_dim,1,hidden_sizes, hidden_activation=hidden_activation)
    q2_net = Mlp(obs_dim+act_dim,1,hidden_sizes, hidden_activation=hidden_activation)
...
if __name__ == '__main__':
    ...
    sac_overwrite(lambda: gym.make(args.env), hidden_sizes=[args.hid] * args.l,
